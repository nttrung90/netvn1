  ...
  return (
    <>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-xs font-bold uppercase tracking-[.17em] text-[#4062ff]">
            Xuất bản
          </p>
          <h1 className="display mt-1 text-4xl font-bold">Bài viết</h1>
        </div>
        <Link
          className="rounded-xl bg-[#101828] px-4 py-3 text-sm font-bold text-white transition hover:bg-gray-800"
